...
for i in range(0,len(quests_name)):
    ...
    quest_requirements = html.fromstring(requests.get("http://oldschoolrunescape.wikia.com" + quests_url[i]).content).xpath('//*[@id="mw-content-text"]/table[2]/tr[5]/td[2]/text()|//*[@id="mw-content-text"]/table[2]/tr[5]/td[2]/node()/text()|//*[@id="mw-content-text"]/table[2]/tr[5]/td[2]/node()/node()/text()|//*[@id="mw-content-text"]/table[2]/tr[5]/td[2]/node()/node()/node()/text()|//*[@id="mw-content-text"]/table[2]/tr[5]/td[2]/node()/node()/node()/node()/text()|//*[@id="mw-content-text"]/table[2]/tr[5]/td[2]/node()/node()/node()/node()/node()/text()|//*[@id="mw-content-text"]/table[2]/tr[5]/td[2]/node()/node()/node()/node()/node()/node()/text()|//*[@id="mw-content-text"]/table[2]/tr[5]/td[2]/node()/node()/node()/node()/node()/node()/node()/text()')
